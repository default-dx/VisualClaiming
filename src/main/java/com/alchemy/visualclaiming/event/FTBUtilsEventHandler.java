...
import com.alchemy.visualclaiming.map.layers.ChunkViewingRenderLayer;
...
public class FTBUtilsEventHandler {
    ...
    public static void onDataReceived(UpdateClientDataEvent event) {
        ...
        if (ChunkClaimingRenderLayer.instance != null) ChunkClaimingRenderLayer.instance.markDirty();
        if (ChunkViewingRenderLayer.instance != null)  ChunkViewingRenderLayer.instance.markDirty();
    }
}
